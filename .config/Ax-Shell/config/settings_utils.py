...
bind = {get_bind_var("prefix_restart_inspector")}, {get_bind_var("suffix_restart_inspector")}, exec, killall {APP_NAME}; uwsm-app -- env GTK_DEBUG=interactive python {home}/.config/{APP_NAME_CAP}/main.py # Restart with inspector
