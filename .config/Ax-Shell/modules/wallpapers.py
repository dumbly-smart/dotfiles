...
class WallpaperSelector(Box):
    ...
    @staticmethod
    def _scheme_for_wallpaper(file_name, selected_scheme):
        """Keep manga-panel wallpapers strictly black and white."""
        if file_name.casefold().startswith("manga-"):
    ...
    def set_random_wallpaper(self, widget, external=False):
        ...
        selected_scheme = self._scheme_for_wallpaper(file_name, selected_scheme)
