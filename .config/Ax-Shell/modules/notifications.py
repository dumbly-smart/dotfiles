...
class NotificationContainer(Box):
    ...
    def on_new_notification(self, fabric_notif, id):
        ...
        is_battery_alarm = notification.app_name == "Battery Monitor"
        if notification_history_instance.do_not_disturb_enabled and not is_battery_alarm:
            logger.info(
...
class NotificationPopup(Window):
    def __init__(self, **kwargs):
        ...
        super().__init__(
            ...
            # Overlay is intentionally used so critical alerts remain visible over
            # fullscreen windows. This window never takes keyboard focus.
            layer="overlay",
            keyboard_mode="none",
            exclusivity="none",
            visible=True,
