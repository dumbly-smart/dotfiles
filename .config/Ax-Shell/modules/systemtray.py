...
class SystemTray(Box):
    def __init__(self, pixel_size: int = 20, **kwargs) -> None:
        ...
        # Gray/libgray can abort the whole Python process when a tray client
        # publishes malformed icon pixmaps (seen with VPN/screen-share apps).
        # If the tray is disabled, do not touch tray item icon data at all.
        self.enabled = data.BAR_COMPONENTS_VISIBILITY.get("systray", True)
